...
if (isset($_POST['submit'])) {
    ...
    // set is_featured to 0 it was uncheked

    $is_featured = $is_featured == 1 ?: 0;

    // chechk and validate input values
    if(!$title) {
        $_SESSION['edit-post'] = "Couldn't update post. Ivalid form data on edit post page.";
    }elseif (!$category_id) {
        $_SESSION['edit-post'] = "Couldn't update post. Ivalid form data on edit post page.";
    }elseif (!$body) {
        $_SESSION['edit-post'] = "Couldn't update post. Ivalid form data on edit post page.";
        ...
        if ($thumbnail['name']) {
            ...
            if (in_array($extension, $allowed_files)) {
                ...
                if ($thumbnail['size']<2000000) {
                    ...
                    $_SESSION['edit-post'] = "File size too big. Shoul be less than 2mb";
